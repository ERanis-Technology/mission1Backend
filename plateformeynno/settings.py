"""
Django settings for plateformeynno project.
...
SECRET_KEY = 'django-insecure-u^++bl&i8_f4_1sm#getzi5st1cxyvkxi(b*x&ljc+ore55vnw'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['192.168.43.160','localhost']
...
ROOT_URLCONF = 'plateformeynno.urls'
...
WSGI_APPLICATION = 'plateformeynno.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'mission1db'),
        'USER': os.getenv('POSTGRES_USER', 'mission1user'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'mission1password'),
        'HOST': 'db',
        'PORT': 5432,
    }
}
