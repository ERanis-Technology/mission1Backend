...
class Professionnel(models.Model):
    ...
    disponibilite = models.CharField(max_length=12,choices=DISPONIBILITE_CHOICES,default='temps_partiel',verbose_name="Disponibilité")
    ...
    reseaux_sociaux = models.CharField(max_length=255,blank=True,null=True,verbose_name="Lien ou pseudo réseaux sociaux")
